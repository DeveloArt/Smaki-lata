import { collection, doc, getDocs, getDoc, addDoc, deleteDoc, updateDoc, query, orderBy } from 'firebase/firestore';
...
export const getAllProducts = async (): Promise<Product[]> => {
  try {
    const productsQuery = query(collection(firestore, COLLECTION_NAME), orderBy('createdAt', 'desc'));
